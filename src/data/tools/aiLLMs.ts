...
export const aiLLMs: Tool[] = [
    {
        id: 'ollama',
        name: 'Ollama',
        description: '开源的 AI 模型运行平台，支持多种模型的本地部署',
    ...
    },
    {
        id: 'chat-gpt',
        name: 'Chat GPT',
        description: 'OpenAI 于2022年11月30日发布，开启了 AI 元年的序幕',
    ...
    },
    {
        id: 'grok',
        name: 'Grok',
        description: 'xAI 设计的 AI 助手，旨在最大化事实与客观性',
        href: 'https://grok.com/',
        category: 'AI 模型',
    },
    {
        id: 'deepseek',
        name: 'DeepSeek',
        description: '深度求索，专注于研究世界领先的通用人工智能底层模型与技术',
    ...
    },
    {
        id: 'minimax',
        name: 'MiniMax',
        description: '致力于推动人工智能向通用人工智能（AGI）迈进',
    ...
    },
    {
        id: 'siliconflow',
        name: '硅基流动',
        description: '为开发者和企业提供高效、低成本且全面的生成式人工智能模型服务',
    ...
    },
    {
        id: 'openrouter',
        name: 'OpenRouter',
        description: 'AI 模型聚合平台，提供多种模型的 API 接入',
    ...
    },
    {
        id: 'megallm',
        name: 'MegaLLM',
        description: 'API 中转服务，支持 OpenAI、Anthropic、Google、Meta 等主流模型',
    ...
    },
    {
        id: 'azure',
        name: 'Azure',
        description: '微软的云计算平台，提供 Azure OpenAI Service 等多种 AI 服务',
    ...
    },
    {
        id: 'volcengine',
        name: '火山方舟',
        description: '字节跳动推出的通用人工智能平台，提供多种 AI 模型和服务',
