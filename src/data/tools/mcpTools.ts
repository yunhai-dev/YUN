...
export const mcpTools: Tool[] = [
    ...
    },
    {
        id: '12306-mcp',
        name: '12306 MCP',
        description: '基于Model Context Protocol (MCP)的12306票务搜索服务器，提供API接口查询12306购票信息。',
    ...
    },
    {
        ...
        description: 'GitHub MCP Server是一个提供文件操作、仓库管理、搜索功能等GitHub API集成的服务工具，适用于开发团队协作和代码管理。',
        href: 'https://github.com/modelcontextprotocol/servers-archived/tree/main/src/github',
        category: 'MCP',
    },
    {
        id: 'knowledge-graph-memory-server',
        name: 'Knowledge Graph Memory Server',
        description: '一个基于MCP的知识图谱记忆服务器，支持图数据库操作和知识查询，适用于构建智能问答和推荐系统。',
    ...
    },
    {
        id: 'context7-mcp',
        name: 'Context7',
        description: 'Context7 MCP 是一项提供最新代码文档和示例的服务，通过直接集成到开发环境中，帮助开发者获取特定版本的库文档，避免使用过时或错误的API信息',
    ...
    },
    {
        ...
        description: '一个可视化 MCP 包含 25 多个可视化图表，用于图表生成和数据分析。',
