...
export const serverTools: Tool[] = [
  {
    ...
    name: "Watchtower",
    description:
      "Docker 容器镜像自动更新工具，监控并自动拉取新镜像、优雅重启容器，适用于家庭实验室和开发环境。",
  ...
  },
  {
    ...
    name: "Komari",
    description:
      "轻量级自托管服务器监控工具，资源占用低，提供直观的 Web 界面查看服务器状态。",
  ...
  },
  {
    ...
    name: "Nexterm",
    description:
      "开源服务器管理软件，支持 SSH、VNC、RDP 远程连接，SFTP 文件管理，Docker 部署及 Proxmox 容器管理。",
  ...
  },
  {
    ...
    name: "Orion Visor",
    description:
      "一款高颜值、现代化的自动化运维及轻量堡垒机，提供全面的服务器智能运维解决方案。",
  ...
  },
  {
    ...
    name: "Warpgate",
    description:
      "完全透明的 SSH、HTTPS、MySQL 和 Postgres 堡垒机/PAM，无需额外的客户端软件",
  ...
  },
  {
    ...
    name: "Mole",
    description:
      "Mac 深度清理优化工具，集成 CleanMyMac、AppCleaner、DaisyDisk、Sensei、iStat 功能于一身。",
  ...
  },
  {
    ...
    name: "trzsz / tssh",
    description:
      "优秀的文件传输工具 (trz/tsz) 和兼容 tmux 的 ssh 客户端替代品 (tssh)。",
  ...
  },
  {
    ...
    name: "Better Stack",
    description:
      "Better Stack 是一个 AI 原生平台，用于值班和事件响应,提供轻松监控、状态页面、 基础设施监控、日志管理和分布式追踪功能。",
