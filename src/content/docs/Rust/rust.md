...
![image-20240525122819358](https://rustfs-endpoint.yhnotes.com/content/image-20240525122819358.png)

- 浅拷贝（shallow copy）
- 深拷贝（deep copy）
- 上面的复制S1内容可能被视未浅拷贝，但是他同时让S1变量失效了，所以这里叫 移动（Move）

![image-20240525123954622](https://rustfs-endpoint.yhnotes.com/content/image-20240525123954622.png)
